package com.zol.backserver.dao;
...
public class CommonDao {
	...
	@PersistenceContext(unitName="zolUnit")
	private EntityManager em;
	
	
	
	//查询对象
	public <T> T queryObject(Class<T> c,Integer key)throws Exception{
		return (T) em.find(c, key);
	}
	
	//删除对象
	public <T> void remove(Class<T> c,Integer key)throws Exception{
